...
AND seance.id_mod = module.id_module
AND seance.id_pr = prof.id_prof
AND heure = '08:00-09:30' AND jour = 'Dimanche'
 ");
...
AND seance.id_gr = groupe.id_groupe
AND seance.id_mod = module.id_module
AND seance.id_pr = prof.id_prof AND heure = '09:40-11:10' AND jour = 'Dimanche'
");
...
AND seance.id_gr = groupe.id_groupe
AND seance.id_mod = module.id_module
AND seance.id_pr = prof.id_prof AND heure = '11:20-12:50' AND jour = 'Dimanche'");
...
AND seance.id_gr = groupe.id_groupe
AND seance.id_mod = module.id_module
AND seance.id_pr = prof.id_prof AND heure = '13:00-14-30' AND jour = 'Dimanche'");
...
AND seance.id_gr = groupe.id_groupe
AND seance.id_mod = module.id_module
AND seance.id_pr = prof.id_prof AND heure = '14-40-16:10' AND jour = 'Dimanche'");
...
AND seance.id_gr = groupe.id_groupe
AND seance.id_mod = module.id_module
AND seance.id_pr = prof.id_prof AND heure = '16:20-17:50' AND jour = 'Dimanche'");
...
<?php if($a36['type'] == true) {  echo '<b>Module :</b>'.$a36['libelle_module'];  } ?> <br/>
 <?php if( $a36['type'] == true){ echo '<b>Prof :</b> '.$a36['nom'].' '.$a36['prenom']; } ?><br /><?php if( $a36['type'] =='Cours') {  echo '<b></b>';} else {echo '<b>Groupe :</b> '.$a36['libelle_groupe'];}?><?php if ( $a36['type'] =='Cours') break; } ?></td>
  ...
  <tr>
    <th style=" height:50px;">Dimanche</th> 
      <td><?php  
