    ...
    <div class="row no-gutters">
      ...
      <div class="col-lg-7 px-5">
        <h1 class="font-weight-bold py-3">
          <img src="image/logo_Bejaia_Univ.png" width="30%" height="30%" alt="">
        </h1>
        ...
        <form method="post" name="connecter" onSubmit="return checkData()">
          ...
          <div class="form-row">
            <div class="col-lg-7 card-footer">
              ...
              <ul>
                <li><a href="http://univ-bejaia.dz/">Bejaia université</a></li>
                <li><a href="https://elearning.univ-bejaia.dz/">E learning université de Bejaia</a></li>
              </ul>
            </div>
          </div>
        </form>
...
<?php  } else { echo "<meta http-equiv='refresh' content='0; menu_principale.php' />";
            $_SESSION['pseudo']=$_POST['pseudo'];
