<?php
$eml=1;$mdc=2;$md=3;
$bdd = new PDO('mysql:host=127.0.0.1;dbname=memoiremaster', 'root', 'sohaib');
...
<title>changer password etudiant</title>
</head>
<body>
<?php include("espace_etudiant.php")?>
<div class="container">
<form style="margin-left:50px; margin-top:330px;" name="changer" action="changer_password_etudiant.php" method="POST" onSubmit="return validation(this)">
 <table width="400" style="margin-right:-100px; color:#fff;"><br />
<tr>
<td colspan="2" style="font-family: monospace; letter-spacing:-2px; color:#FFF; font-size:24px; padding-bottom:30px;"> Modification Password</td><br />
</tr><tr></tr>
<tr>

<td height="30"><label <?php if($eml==0){?>style="color:#FF0000;"<?php }?>><span style="font-size:18px;color:#FFF;font-family: monospace;letter-spacing:-1px;">Login</span></label>
</td>
...
<tr> </tr>
<td height="30"><label for="nouveau_mdp" <?php if($md==0){?>style="color:#FF0000;"<?php }?>><span style="font-size:18px;color:#FFF;font-family: monospace;letter-spacing:-1px;">Nouveau Mot de passe</span></label></td>
