...
$var=$id_section;
$ligne1=mysqli_fetch_array(mysqli_query($db,"SELECT libelle_module, groupe.id_groupe AS id_groupe, prof.nom, prof.prenom, module.id_module, formation.nom_formation AS formation, libelle_groupe, semestre.libelle_semestre AS semestre, semestre.session, section.lib_section AS lib_sec, section.id_section as id_section , seance.id_sec
...
<p style="font-family: monospace;letter-spacing:2px;  text-align:center; font-size:22px; color:#000" > EMPLOI DU TEMPS  </p> 
<p style="font-family: monospace;letter-spacing:2px; text-align:center; margin-top:-25px; font-size:22px; color:#000" >  FORMATION :<span style="color:#00F"><?php echo $formation;?> </span>&nbsp;&nbsp;&nbsp;SEMESTRE :<span style="color:#00F"> <?php echo $semestre;?></span> &nbsp;&nbsp;&nbsp;SECTION : <span style="color:#00F"><?php echo $lib_sec;?></span>
 <input style=" margin-left:20px;"   class="aqx1" name="imprimer" onClick="imprimer()" type="button" value="Imprimer">
 </p>
 </div></center>
...
<thead>
  <tr class="ligne">
   <th></th>
    <th style="height:35px;font-weight:bold;background-color:rgba(102,102,102,.3);">-09:30-08:00</th>
    <th style="height:35px;font-weight:bold;background-color:rgba(102,102,102,.3);">11:00-09:30</th>
    <th  style="height:35px;font-weight:bold;background-color:rgba(102,102,102,.3);">12:30-11:00</th>
    <th style="height:35px;font-weight:bold;background-color:rgba(102,102,102,.3);">14:00-12:30</th>
    <th style="height:35px;font-weight:bold;background-color:rgba(102,102,102,.3);">15:30-14:00</th>
    <th style="height:35px;font-weight:bold;background-color:rgba(102,102,102,.3);">17:00-15:30</th>
  </tr></thead>
  <tbody>
 <tr>
    <th style=" height:50px;"  >السبت</th> 
      <td><?php  
...
<?php if( $a6['type'] =='Cours') {  echo '<b></b>';} else if( $a6['type'] ==('TD' || 'TP')) {   echo '<b>Groupe :</b> '.$a6['libelle_groupe'];} else echo'<b></b> '; ?> <br><?php if ( $a6['type'] =='Cours') break; } ?></td>
  ...
  <tr>
      <th  style=" height:50px;">الاثنين</th>
    <td><?php  
...
<?php if( $a12['type'] =='Cours') {  echo '<b></b>';} else if( $a12['type'] ==('TD' || 'TP')) {   echo '<b>Groupe :</b> '.$a12['libelle_groupe'];} else echo'<b></b> '; ?> <br><?php if ( $a12['type'] =='Cours') break; } ?></td>
  ...
  <tr>
    <th class="mam" style=" height:50px;">الثلاثاء</th>
    <td><?php  
...
<?php if( $a18['type'] =='Cours') {  echo '<b></b>';} else if( $a18['type'] ==('TD' || 'TP')) {   echo '<b>Groupe :</b> '.$a18['libelle_groupe'];} else echo'<b></b> '; ?> <br><?php if ( $a18['type'] =='Cours') break; } ?></td>
  ...
  <tr>
    <th style=" height:50px;"  >الاربعاء</th>
    <td><?php  
...
<?php if( $a24['type'] =='Cours') {  echo '<b></b>';} else if( $a24['type'] ==('TD' || 'TP')) {   echo '<b>Groupe :</b> '.$a24['libelle_groupe'];} else echo'<b></b> '; ?> <br><?php if ( $a24['type'] =='Cours') break; } ?></td>
  ...
  <tr>
    <th style=" height:50px;"  >الخميس</th>
   <td><?php  
