...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/essaye.css">
    <!-- <link rel="Shortcut Icon" href="image/ummto1.png" type="image/x-icon"> -->
...
<header class="header-area overlay">
    <nav class="navbar navbar-expand-md navbar-dark">
        <div class="container">
           <img src="image/Logo_Univ_BejaiaNB.png" height="11%" width="11%" style="margin-top: -6px;" alt="Logo_Bejaia_Univ">
            ...
            <div id="main-nav" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    <li><a href="gestion_des_emplois_de_temps.php" title=" Emplois de temps" class="nav-item nav-link active"> EDT </a></li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                     ...
                     <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="ajouetr_formation.php" title="ajouter une formations" class="dropdown-item">Ajouter une foemation</a>
                        </div>
                    </li>
                     <li class="dropdown">
